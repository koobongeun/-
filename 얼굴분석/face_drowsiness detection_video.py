...
#소리를 내기위해 사용
pygame.mixer.init()
pygame.mixer.music.load('C:/computervision/audio/fire-truck.wav')
...
#harrcascade로 정면 얼굴 검출
face_cascade_name = 'C:/computervision/haarcascades/haarcascade_frontalface_alt.xml'
# 객체 생성
